...
compres = readRDS("rds/wuv_compres_rna_nkcells.rds")
...
genes_of_interest = c("GZMB", "KLRB1", "CRTAM")
...
bracketx = c("ND" = 1-0.3, "AAb+" = 1.0, "T1D" = 1+0.3)
pdf("/srv/http/betts/hpap/figures/nkcell_GZMB-KLRB1_CRTAM.violins.pdf", width = 11, height=8)
for (g in genes_of_interest) {
